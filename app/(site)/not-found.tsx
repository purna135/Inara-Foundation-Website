...
export const metadata: Metadata = {
  ...
  description: "The page you are looking for does not exist or has been moved. Visit our homepage or explore our projects to find what you need.",
  robots: { index: false, follow: true },
};

export default function NotFound() {
  return (
    <div className="relative min-h-[80vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-brand-50 via-white to-brand-50/40">
