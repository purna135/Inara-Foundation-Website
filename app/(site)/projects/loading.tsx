      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-brand-50 via-white to-brand-50/40">
        <div className="container-px mx-auto max-w-[1200px] py-20 sm:py-28">
          <div className="mx-auto max-w-3xl text-center">
            <div className="mx-auto h-8 w-32 animate-pulse rounded-full bg-neutral-200" />
            <div className="mx-auto mt-6 h-12 w-80 animate-pulse rounded-xl bg-neutral-200" />
            <div className="mx-auto mt-4 h-5 w-96 animate-pulse rounded-lg bg-neutral-100" />
          </div>
        </div>
      </section>
