...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "From a passion project to a registered Section 8 non-profit. See how Inara Foundation drives community upliftment, animal welfare, and youth-led change.",
    images: [
      {
