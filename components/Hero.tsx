...
const slidesData: Slide[] = [
  ...
  },
  {
    ...
    title: 'Your Small Act Can Make a Big Difference.',
    highlight: 'Small Act',
    description:
  ...
  },
  {
    ...
    title: 'Be the Voice for the Voiceless.',
    highlight: 'Be the Voice',
    description:
      'Empowering communities through compassion, action, and impactful initiatives.',
