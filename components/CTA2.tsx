...
export default function CTA2() {
  return (
    <Section size="dense">
      <div className="relative rounded-2xl ring-1 ring-neutral-200 shadow-sm bg-gradient-to-r from-teal-800 to-teal-600">
        <div className="grid items-center gap-6 px-6 py-8 sm:px-10 md:grid-cols-2">
          <div className="max-w-lg">
            <div className="inline-flex items-center gap-2 rounded-full bg-neutral-900/10 px-3 py-1 text-xs font-medium text-white backdrop-blur-sm mb-2">
