  ...
  return (
    <Section className="bg-white" size="dense">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <h2 className="mt-1 font-display text-3xl sm:text-4xl">What our collaborators say</h2>
        <p className="mt-2 text-neutral-700">Real words from Inara collaborators about their experience and growth.</p>
      </div>
